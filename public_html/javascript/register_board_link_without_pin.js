...
//alert(path_temp);
    ...
    $("#prodcut_id").blur(function() {
        ...
        var prdct_amount = path_root + "register_board/product_amount";
        $.post(prdct_amount, {p_id: prdct_id}, function(data) {

            if (data != 'no') {
                //$('span#total_product_amount').html(data);
                var register_amount_path = path_root + "register_board/register_amount";
...
//            });
    ...
    $("#user_name_entry").blur(function()
    {
        ...
        {
            var user_name_availability = path_root + "register_board/checkUserNameAvailability"
            var msg;
    ...
    $("#ref_username").blur(function()
    {
...

        {
            ...
            var ref_user_availability = path_root + "register_board/checkRefUserAvailability"
            //remove all the class add the messagebox classes and start fading
    ...
    function getreferralname(referral_name)
    {
        ...
        var get_referral_name = path_root + "register_board/get_referral_name";
        $.post(get_referral_name, {username: $('#ref_username').val()}, function(data)
        {
            data = trim(data);
            html = "<div class='form-group'>  <label class='col-sm-3 control-label' for='ref_username'>Sponsor Full Name:<font color='#ff0000'>*</font></label> <div class='col-sm-7'><input type='text' name='referal_name' id='reeral_name' maxlength='20' autocomplete='Off' value='" + data + "' readonly='true' class='form-control'/></div></div>";
...
//    {
//        var balance_available = path_root + "register_board/checkBalanceAvailable";
//        var msg;

...
function validate_admin_pass() {
    ...
    var current_pwd_admin = change_pass_admin.current_pwd_admin.value;
    var new_pwd_admin = change_pass_admin.new_pwd_admin.value;
    var confirm_pwd_admin = change_pass_admin.confirm_pwd_admin.value;

    if (change_pass_admin.current_pwd_admin)
    {

        if (current_pwd_admin == "")
        {
            msg = $("#error_msg1").html();
            inlineMsg("current_pwd_admin", msg, 4);
            return false;
        }
    }
    ...
    if (change_pass_admin.new_pwd_admin)
    {

        if (new_pwd_admin == "")
        {
            msg = $("#error_msg2").html();
            inlineMsg("new_pwd_admin", msg, 4);
            return false;
        }
    }
    ...
    if (change_pass_admin.confirm_pwd_admin)
    {

        if (confirm_pwd_admin == "")
        {
            msg = $("#error_msg4").html();
            inlineMsg("confirm_pwd_admin", msg, 4);
            return false;
        }
    }
    ...
    if (change_pass_admin.confirm_pwd_admin)
    {
        ...
        if (confirm_pwd_admin != new_pwd_admin)
        {
            msg = $("#error_msg5").html();
            inlineMsg("confirm_pwd_admin", msg, 4);
            return false;
        ...
        $('#change_pass_common').validate({
            ...
            messages: {
                ...
                new_pwd_common: {required: msg5,
                    minlength: msg2},
                confirm_pwd_common: {required: msg4,
                    minlength: msg2,
                    equalTo: msg3}

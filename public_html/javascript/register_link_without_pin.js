   ...
   var msg;
    msg = $("#validate_msg69").html();
...

        {
            ...
            $("#errmsg33").html(msg).show().fadeOut(1200, 0);
...
*/
    ...
    $("#ref_username").blur(function ()
    {
...

        {
            ...
            $("#referral_box").html('<img align="absmiddle" src="' + path_temp + 'images/loader.gif" />'+msg).show().fadeTo(1900, 1);
    ...
    function getreferralname(referral_name)
    {
        var html;
           var msg;
           msg = $("#validate_msg65").html(); 
        var get_referral_name = path_root + "register/getReferralName";
        $.post(get_referral_name, {username: $('#ref_username').val()}, function (data)
        {
            data = trim(data);
            html = "<div class='form-group'>  <label class='col-sm-3 control-label' for='ref_username'>"+msg+":<font color='#ff0000'>*</font></label> <div class='col-sm-7'><input type='text' name='referal_name' id='reeral_name' autocomplete='Off' value='" + data + "' readonly='true' class='form-control'/></div></div>";

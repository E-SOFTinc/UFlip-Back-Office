function validateEpinAllocation(form)
{
    var user = document.user_select_form.user_name.value;
    var product = document.user_select_form.product.value;
    var count = document.user_select_form.count.value;
    var msg;
    if (user == "")
    {
        msg = $("#error_msg1").html();
...
{
    var stdate = document.frm_view_pin.week_date1.value;
    var enddate = document.frm_view_pin.week_date2.value;
    var msg;
    if (stdate == "")
    {
        msg = $("#error_msg1").html();
...
{
    var user = document.frm_pin.user.value;
    var msg;
    if (user == "")
    {
        msg = $("#error_msg1").html();
        inlineMsg('user', msg, 2);
        return false;
    }

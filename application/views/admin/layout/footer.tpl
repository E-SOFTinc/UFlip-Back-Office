                ...
                <div class="panel panel-default">
                    <div class="panel-body no-padding" >
                        ...
                        <div class="pull-left notetxt col-sm-10">
                            ...
                            <p><font color="black">
                                1.   {$tran_this_demo_can_customize_your_own_mlm_plan_with_fully_licensed_mode} <br/>
                        ...
                        <div class="pull-left notetxt col-sm-10">
                            <p>              
                                {if $upgrade_cond==active} 
                                            <!-- <font color="black">{$tran_please} </font>
                                           <a href="{$BASE_URL}admin/revamp/revamp_update_plan">{$tran_click_here_to_upgrade}</a>-->
                                    ...
                                    <br/>
                                {/if}
                                <a href="{$BASE_URL}admin/revamp/send_feedback">{$tran_click_here_to_place_a_feedback_for_support} </a> <br />
...
<div class="footer clearfix">
    <div class="footer-inner">
        ...
        2015 &copy; {$site_info['company_name']} {if $FOOTER_DEMO_STATUS=='yes'}- <a href="https://ioss.in" target="_blank">Developed by Infinite Open Source Solutions LLP&trade;</a> <!--- <a href="https://ioss.in" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Need more help about this page?</a><div class="help-icon-bottom"><a href="#" target="_blank"><i class="clip-info"></i></a></div>-->
       {/if}
        </div>
...
<script type="text/javascript">
    ...
    function idleSessout()
    {
        ...
        var post_path = '{$BASE_URL}' + "admin/time/get_session_time";
        jQuery.post(post_path, {}, function(data)
        {
            ...
            if ((time_now - time) >= 600) { //time in seconds
                ...
                document.location.href = '{$BASE_URL}' + "admin/login/logout";
            }
        });
    }
</script>
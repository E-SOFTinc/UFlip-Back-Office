            ...
            <div class="panel-body">
                <form role="form" class="smart-wizard form-horizontal" name="weekly_join" id="weekly_join" action="" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="week_date1">{$tran_date} 1<span class="symbol required"></span></label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="week_date2">{$tran_date} 2<span class="symbol required"></span></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                    ...
                    <table  class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                        <thead>
                            <tr class ='th' >
                                ...
                                <th>{$tran_user_name}-{$tran_full_name}</th>
                                <th class="hidden-xs">{$tran_total_amount}</th>
                        ...
                        <tbody>
                            ...
                            {else}
                                <tr>
                                <tr><td colspan="9" align="center"><h4>{$tran_no_leg_count_found}</h4></td></tr>
                                </tr>
                            {/if}
                        </tbody>
                    </table>

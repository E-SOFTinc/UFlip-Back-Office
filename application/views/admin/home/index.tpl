        ...
        {if $ewallet_status == "yes"} 
            <div class="col-sm-3">
                <div class="core-box gadget-box">
                    ...
                    <div class="content">
                        <p>
                            {$tran_total_amount} : <redspan>{round($total_amount,2)}</redspan>
                        </p>
                        <p>
                            {$tran_total_requested}: <redspan>{if $requested_amount}{$requested_amount}{else}0{/if}</redspan>
                        </p>
                        <p>
                            {$tran_total_released} : <redspan>{if $released_amount}{$released_amount}{else}0{/if}</redspan>
                        </p>
...
<script>
    ...
    {/foreach}
        ...
        var runChart2 = function() {
            ...
            data_pie[0] = {
                label: "{$tran_released_amount}",
                data: {$released_payouts_percentage}
            },
            data_pie[1] = {
                label: "{$tran_pending_amount}",

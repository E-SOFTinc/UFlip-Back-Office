        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="bord-box"> 
                    ...
                    <div class="bor-box">
                        ...
                        <div class="brd-plan-3">
                            ...
                            {else}
                                {$div_class="level-3-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 70px">
                    ...
                    <!--box-5-->
                    <div class="bor-box" style="">

                        <div class="brd-plan-3">
                            {if  {$downline_board_id_arr["level4"][1]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 -7px">
                                <a  id='userlink{$downline_board_id_arr["level4"][1]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][1]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][2]["user_name"]}!=''}
                                {$div_class="level-4-mid"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" >
                                <a  id='userlink{$downline_board_id_arr["level4"][2]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][2]["user_name"]}</p>
                                </a>
                            </div>
                        ...
                        <!--new-box-->		
                        <div class="brd-plan-3">
                            {if  {$downline_board_id_arr["level4"][3]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 10px">
                                <a  id='userlink{$downline_board_id_arr["level4"][3]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][3]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][4]["user_name"]}!=''}
                                {$div_class="level-4-mid"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" >
                                <a  id='userlink{$downline_board_id_arr["level4"][4]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][4]["user_name"]}</p>
                                </a>
                            </div>
                        ...
                        <div class="brd-plan-3">
                            {if  {$downline_board_id_arr["level4"][5]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 10px">
                                <a  id='userlink{$downline_board_id_arr["level4"][5]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][5]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][6]["user_name"]}!=''}
                                {$div_class="level-4-mid"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" >
                                <a  id='userlink{$downline_board_id_arr["level4"][6]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][6]["user_name"]}</p>
                                </a>
                            </div>
                        ...
                        <div class="brd-plan-3">
                            {if  {$downline_board_id_arr["level4"][7]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 10px">
                                <a  id='userlink{$downline_board_id_arr["level4"][7]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][7]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][8]["user_name"]}!=''}
                                {$div_class="level-4-mid"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" >
                                <a  id='userlink{$downline_board_id_arr["level4"][8]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][8]["user_name"]}</p>
                                </a>
                            </div>
                        ...
                        <div class="brd-plan-3">
                            {if  {$downline_board_id_arr["level4"][9]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 50px">
                                <a  id='userlink{$downline_board_id_arr["level4"][9]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][9]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][10]["user_name"]}!=''}
                                {$div_class="level-4-mid"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" >
                                <a  id='userlink{$downline_board_id_arr["level4"][10]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][10]["user_name"]}</p>
                                </a>
                            </div>
                        ...
                        <div class="brd-plan-3">
                            ...
                            {if  {$downline_board_id_arr["level4"][11]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class} " style="margin: 0 5px 0 10px" >
                                <a  id='userlink{$downline_board_id_arr["level4"][11]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][11]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][12]["user_name"]}!=''}
                                {$div_class="level-4-mid"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 10px">
                                <a  id='userlink{$downline_board_id_arr["level4"][12]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][12]["user_name"]}</p>
                                </a>
                            </div>
                        ...
                        <div class="brd-plan-3">
                            ...
                            {if  {$downline_board_id_arr["level4"][13]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin: 0 5px 0 10px">
                                <a  id='userlink{$downline_board_id_arr["level4"][13]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][13]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][14]["user_name"]}!=''}
                                {$div_class="level-4-mid"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" >
                                <a  id='userlink{$downline_board_id_arr["level4"][14]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][14]["user_name"]}</p>
                                </a>
                            </div>
                        ...
                        <div class="brd-plan-3">
                            ...
                            {if  {$downline_board_id_arr["level4"][15]["user_name"]}!=''}
                                {$div_class="level-4-small"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin:0 0 0 10px;">
                                <a  id='userlink{$downline_board_id_arr["level4"][15]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][15]["user_name"]}</p>
                                </a>
                            </div>

                            {if  {$downline_board_id_arr["level4"][16]["user_name"]}!=''}
                                {$div_class="level-4-mid{$board2_class}"}
                            {else}
                                {$div_class="level-4-mid-vacant"}
                            {/if}
                            <div class="{$div_class}" style="margin:0 0 0 10px;">
                                <a  id='userlink{$downline_board_id_arr["level4"][16]["id"]}'>
                                    <p>{$downline_board_id_arr["level4"][16]["user_name"]}</p>
                                </a>
                            </div>

                ...
                {if $cnt_adminmsgs > 0}
                    {foreach from=$adminmsgs item=v}
                        ...
                        {if $v.read_msg=='yes'}
                            ...
                            <tr>
                                <!-- <td>                                
                                     <a href ="javascript:getOneMessage({$id},{$user_id},'{$user_type}','{$BASE_URL}admin')" rel='popuprel' class='popup' style='color:#C48189;'> {$page+$i} </a>
                                 </td> -->
                                <td>
                        ...
                        {else}	   
                            ...
                            <tr>
                                <!-- <td>
                                     <a href ="javascript:getOneMessage('{$id}','{$user_id}','{$user_type}','{$BASE_URL}admin')" rel='popuprel' class='popup' style='color:black;'>{$page+$i}</a>
                                 </td> -->
                                <td>
                                    {$user_name = $user_name_arr[$i-1]['user_name']}

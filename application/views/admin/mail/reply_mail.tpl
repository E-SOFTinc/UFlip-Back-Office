                ...
                <form role="form" class="smart-wizard form-horizontal" method="post" name="compose" id="compose"  >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" id="user_id1" name="user_id1"  onKeyUp="ajax_showOptions(this, 'getCountriesByLetters','no',event)" autocomplete="Off" tabindex="1" value="{$reply_user}" readonly class="col-sm-2 form-control"/>
                        </div>

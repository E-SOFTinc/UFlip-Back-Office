    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" class="smart-wizard form-horizontal" method="post"  name="report_config" id="report_config" >
                    <div class="col-md-12">
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-6">
                            <textarea  name="addr" id="addr"    autocomplete="Off" >{$setresult['address']}</textarea>
                        </div>
                    </div>
                    <div class="form-group">

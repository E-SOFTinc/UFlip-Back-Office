                    ...
                    <div class="col-sm-12">
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {if $regr['gender'] == 'M'}
                                        <td class="column-right">{$tran_male}
                                            {else}
                                    <td class="column-right">{$tran_female}
                                        {/if}
                                    </td>
                                </tr>
                        ...
                        <div class="form-group">
                            <form name="" id="" method="post">
                                ...
                                <div class="col-sm-2 col-sm-offset-3">
                                    <button class="btn btn-bricky" style="padding-right: 20px"  name="verify_cancel" type="submit"value="{$tran_cancel_register}">{$tran_cancel_register}</button>
                                </div>
                            </form>
                        </div>

...
<innerdashes>
    ...
    <cdash-inner>
        <form class="niceform" action="" method="post"  name="upload_news" id="upload_news"  onSubmit="return validate_newsupload(this);" >
            <div id="inputs">
                <table width="100%" border="0"  >
                    ...
                    <tr height="30" class="text">
                        ...
                        <td><textarea rows="4" name="news_desc" id="news_desc" cols="22" tabindex="2" >{$news_desc}</textarea></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>

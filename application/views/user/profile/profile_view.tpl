            ...
            <div class="panel-body">
                <form role="form" class="smart-wizard form-horizontal" name="searchform" id="searchform" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input placeholder="{$tran_type_members_name}" class="form-control" type="text" id="user_name" name="user_name"  onKeyUp="ajax_showOptions(this, 'getCountriesByLetters', event)" autocomplete="Off" tabindex="1" >
        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div id="panel_overview" class="tab-pane in{$tab1}">
                    <div class="row">
                        <div class="col-sm-5 col-md-12">
                            <div class="user-left">
                                ...
                                <table class="table table-condensed table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="160px">{$tran_placement_user_name}  </td><td width="50px"> : </td>
                                            <td>{$sponser['name']} </td>
                                        ...
                                        {if $mlm_plan!= "Board"}
                                            <tr>
                                                ...
                                                <td>
                                            {if $details["detail1"]["position"]=='L'} {$tran_left} {elseif $details["detail1"]["position"]=='R'} {$tran_right} {/if} </td>
                        ...
                        <table class="table table-condensed table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td  width="160px">{$tran_name} </td><td width="50px"> : </td>
                                    <td>{$details["detail1"]["name"]} </td>

                                </tr>
                                <tr>
                                    <td>{$tran_user_name}  </td><td width="50px"> : </td>
                                    <td>
                                        {$u_name} </td>
                                ...
                                <tr>
                                    <td>{$tran_date_of_birth} </td><td width="50px"> : </td>
                                ...
                                <tr>
                                    <td>{$tran_gender}  </td><td width="50px"> : </td>
                                ...
                                <table class="table table-condensed table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td  width="160px">{$tran_address} </td><td width="50px"> : </td>
                                        ...
                                        {/if}*}
                                        <tr>
                                            <td>{$tran_pincode}  </td><td width="50px"> : </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>{$tran_land_line_no}  </td><td width="50px"> : </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>{$tran_email}  </td><td width="50px"> : </td>
                                            <td>
                                ...
                                <tbody>
                                <tr>
                                <td width="160px">{$tran_nominee_name}</td><td width="50px"> : </td>
                              ...
                              {*  <table class="table table-condensed table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="160px">{$tran_pan_no}</td><td width="50px"> : </td>
                               ...
                               {* <table class="table table-condensed table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="160px">{$tran_Facebook}</td><td width="50px"> : </td>
                ...
                <div id="panel_edit_account" class="tab-pane{$tab2}">
                    <form role="form" method="post" name="user_register" id="user_register" action="{$BASE_URL}user/profile/profile_view" enctype="multipart/form-data" >     
                        <div class="col-md-12">
                            <div class="errorHandler alert alert-danger no-display">
                                <i class="fa fa-times-sign"></i> {$tran_errors_check}
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label class="form-control" readonly="true">
                                        {$details["detail1"]["name"]}
                                    </label>

                                    <input  class="form-control" name="full_name"  id="full_name" type="hidden" size="22" {if $user_type!='admin'} readonly="readonly" {/if} maxlength="50" value="{$details["detail1"]["name"]}" /></td>
						...
						{form_error('full_name')}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="username" id="username" type="hidden"  size="22" maxlength="20" value="{$u_name}" /></td>		{form_error('username')}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="row" readonly="true">
                                        <input  class="form-control" name="date_of_birth" id="date_of_birth" type="hidden" size="16" maxlength="10" value="{$details["detail1"]["dob"]}" readonly />  
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">                      
                                                <select name="gender" id="gender" tabindex="4"  class="form-control">
                                                    <option value="" tabindex="10">{$tran_select_gender}</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea  class="form-control"rows="4" name="address" id="address" cols="17" tabindex="5" >{$details["detail1"]["address"]}</textarea></td>
					{form_error('address')}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9"> 
                                                    ...
                                                    <select name="state" id="state" tabindex="7" {*onChange="getStateProfile(this.value, 'admin')"*} class="form-control">
                                                        {$state}
                                                    </select>                                    
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                <div class="col-md-9">   
                                <input type='text' name='town' id='town' tabindex='9'value="{$details["detail1"]["town"]}"/></div>                                
                                </div>
                                </div>
                                </div>
                                </div>*}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input  class="form-control" name="pin" id="pin" type="text" tabindex='10' size="8" maxlength="6" placeholder="{$details["detail1"]["pincode"]}" value="{$details["detail1"]["pincode"]}"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"  name="mobile" id="mobile" type="text" tabindex="11" size="22" maxlength="10" autocomplete="Off" {*placeholder="{$details["detail1"]["mobile"]}"*}  value="{$details["detail1"]["mobile"]}"/>
					{form_error('mobile')}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="land_line"  id="land_line"  type="text" tabindex="12" size="22" maxlength="20"  placeholder ="{$details["detail1"]["land"]}" value="{$details["detail1"]["land"]}"/>

                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">{$tran_email}</label>

                                        <input class="form-control" name="email"  id="email" type="text" tabindex="13" size="22" maxlength="100" autocomplete="Off" value="{$details["detail1"]["email"]}"/>
                            ...
                            <input type="text"  tabindex="14" placeholder="{$details["detail1"]["nominee"]}" value="{$details["detail1"]["nominee"]}" class="form-control" name="nominee"  id="nominee" >
                            </div>
                            </div>
                            ...
                            <input class="form-control" placeholder="{$details["detail1"]["relation"]}" value="{$details["detail1"]["relation"]}" type="text"  name="relation"  id="relation" tabindex="15">
                            </div>
                            </div>
                            </div>*}
                           <!-- <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{$details["detail1"]["pan"]}" value="{$details["detail1"]["pan"]}" class="form-control" name="pan_no" id="pan_no" tabindex="16">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="{$details["detail1"]["acnumber"]}" value="{$details["detail1"]["acnumber"]}" type="text" name="bank_acc_no" id="bank_acc_no" tabindex="17" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{$details["detail1"]["ifsc"]}" value="{$details["detail1"]["ifsc"]}" class="form-control" name="ifsc" id="ifsc" tabindex="18">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="{$details["detail1"]["nbank"]}" value="{$details["detail1"]["nbank"]}" type="text"  name="bank_name" id="bank_name" tabindex="19">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="{$details["detail1"]["nbranch"]}" value="{$details["detail1"]["nbranch"]}" type="text" name="bank_branch" id="bank_branch" tabindex="20">
                                    </div>
                                </div>
                            </div>-->
                           {* <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{$details["detail1"]["facebook"]}" value="{$details["detail1"]["facebook"]}" class="form-control" name="facebook"  id="facebook" tabindex="21"><font size = "1" color = "red"><b>Eg: https://www.facebook.com/example </b></font>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{$details["detail1"]["twitter"]}" value="{$details["detail1"]["twitter"]}" class="form-control"  name="twitter"  id="twitter" tabindex="22"><font size = "1" color = "red">&nbsp;<b>Eg: https://twitter.com/#!/example </b></font>
                                    </div>
                                </div>
                            </div>*}

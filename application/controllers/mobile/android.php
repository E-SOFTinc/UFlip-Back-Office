    ...
    public function register(){
        ...
        if($this->input->post("tag") == "validateRegister"){
            ...
            if($response["validUser"]){
                ...
                //$response["moduleStatus"] = $this->android_model->getModuleStatus($tprefix);
         ...
         /*   
            ...
            $details["banckacno"] = "1234567890";
            $details["bankname"] = "bankname";
            $details["branchname"] = "branchname";
            $details["country"] = "india";
            $details["dob"] = "2011-04-24";
            $details["email"] ="sanoosxsssspp6@gl.com";
            $details["gender"] = "M";
            $details["ifsc"] = "IFSC";
            $details["landphone"] = "2342343";
            $details["mobile"] = "9567742326";
            $details["name"] = "sanooppm";
            $details["pan"] = "234234WRSKL";
            $details["password"] = "123456";
            $details["pin"] = "23434";
            $details["placementfullname"] = "sanoop";
            $details["placementusername"] = "287105";
            $details["position"] = "L";
            $details["product"] = "Silver";
            $details["productid"] = "1";
            $details["productvalue"] = "100";
            $details["sponserfullname"] = "sanoop";
            $details["sponserusername"] = "287105";
            $details["state"] = "kerala";
            $details["username"] ="test15";
            $details["loginuser"] = "287105";*/
           ...
           /* $msg['status'] = "true";
            $pay_type = "E-Pin";
             $pin_detail['pin0'] = "cyoczkfhnv"; 
                    $pin_detail['amount0'] = "0";
                             $pin_detail['pin0'] = "oxxyglyajo";
                    $pin_detail['amount0'] = "300";
                    $length =2;
                    $tprefix = "34";
                    $details["loginuser"] = "admin";*/
            if($pay_type == "Paypal"){

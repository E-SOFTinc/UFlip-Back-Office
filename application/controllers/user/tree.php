...
class Tree extends Inf_Controller {
        ...
        if ($this->input->post('go_submit')) {
            ...
            if ($user_id < $child_id) {
                ...
                if ($status == "yes") {
                    ...
                    redirect("user/tree/tree_view/$go", 'refresh');
                } else {
    ...
    public function sponsor_tree($user_id = "") {
        ...
        if ($this->input->post('go_submit')) {
            ...
            if ($user_id <= $child_id) {
                ...
                if ($status == "yes") {
                    ...
                    //$go = urlencode($go);
                    $msg = $this->lang->line('you_could_only_search_downline_users');
        ...
        if ($this->validation->isUserAvailable($id_decrypt)) {
            ...
            $this->tree_model->intitailze();
            $user_details = $this->tree_model->getUserDetailss($id_decrypt);
            $this->set('user_details', $user_details);
            ...
            $display = $this->tree_model->viewUnilevelTree($user_id, $id_decrypt);
    ...
    public function select_tree() {
        ...
        $this->set("page_top_header", $this->lang->line('tabular_tree'));
        $this->set("page_top_small_header", "");
    ...
    public function genology_tree() {
        ...
        if ($this->input->post('go_submit')) {
            ...
            if ($user_id != "") {
                if ($logged_user_id <= $user_id) {
                    $status = $this->tree_model->userDownlineUser($user_id, $logged_user_id);
                    if ($status == 'yes') {
                        $id_encode = $this->encrypt->encode($user_id);
                        $id_encode = str_replace("/", "_", $id_encode);
                        $encrypt_id = urlencode($id_encode);
        ...
        $this->ARR_SCRIPT[1]["name"] = "style_tree.css";
        $this->ARR_SCRIPT[1]["type"] = "css";
        $this->ARR_SCRIPT[1]["loc"] = "header";

        $this->ARR_SCRIPT[2]["name"] = "easyTooltip.js";
        $this->ARR_SCRIPT[2]["type"] = "js";
        $this->ARR_SCRIPT[2]["loc"] = "header";

        $this->ARR_SCRIPT[3]["name"] = "zoom.js";
        $this->ARR_SCRIPT[3]["type"] = "js";
        ...
        $this->set("tran_binary_genealogy_view", $this->lang->line('binary_genealogy_view'));
        $this->set("tran_profile_management", $this->lang->line('profile_management'));
        $this->set("page_top_header", $this->lang->line('tree_views'));
        $this->set("page_top_small_header", "");
        $this->set("page_header", $this->lang->line('genealogy_tree'));
        $this->set("page_small_header", "");
        ...
        if ($this->input->post('go_submit')) {
            ...
            if ($user_id < $child_id) {
                ...
                if ($status == "yes") {
                    ...
                    redirect("user/tree/tree_view_sponsor/$go", 'refresh');
                } else {
                    //$go = $this->encrypt->encode($user_id);
                    //$go = urlencode($go);
    ...
    function tree_view_board($user_id = "", $board_no = '') {
        ...
        $this->set("page_top_header", $this->lang->line('tree_view'));
        $this->set("page_top_small_header", "");
        $this->set("page_header", $this->lang->line('tree_view'));
        $this->set("page_small_header", "");

...
for($i=0;$i<count($arr);$i++)
    {
       ...
       $m="m";
        ...
        if($menu[0] == $m)
            {
                //$text = $this->getMenuTextId($menu[1],$this->table_prefix);
        ...
        {
           //$text = $this->getOtherLink($menu[1],$this->table_prefix);
        ...
        {
            //$text_main = $this->getMenuTextId($menu[0],$this->table_prefix);
            //$text = $this->getSubmenuText($menu[1],$this->table_prefix);
            //echo"m[1]=".$menu[1]."<br>";
            ...
            /*echo "other";
           print_r($other_menu_arr);
            echo "<br>menu";
           print_r($menu_arr);
             echo "<br>sub menu";
           print_r($sub_menu_arr);*/
    ...
    $menu_id = $this->getMenuId($this->table_prefix);
        ...
        while($row = mysql_fetch_array($menu_id))
        {
            ...
            $sub_row= $this->getsubMenuId($row['id'],$this->table_prefix);
                ...
                // $c =$this->check($sub_row,$sub_menu_main_arr);
                 //$row1 = mysql_fetch_array($sub_row);
                 //if(in_array($row1['sub_refid'],$sub_menu_main_arr ))
                            //$c=0;
    ...
    //$arrays['sub_menu_arr'] = $sub_menu_arr;

...
class complaint extends Model {
    ...
    }//FUNCTION ENDS [ public function getUserDatils($user_id) ]
    ...
    public function SubmitTicket($user_id,$priority,$dept,$query)
    {
        ...
        $complaint_ticket_table = $this->table_prefix."complaint_ticket_table";
        ...
        while ($row = mysql_fetch_array($query))
            {
                ...
                $ticket_details[$i]["owner_user_name"] = $this->obj_vali->IdToUserName($ticket_details[$i]["owner_id"]);
                $ticket_details[$i]["owner_full_name"] = $this->obj_vali->getFullName($ticket_details[$i]["owner_id"]);

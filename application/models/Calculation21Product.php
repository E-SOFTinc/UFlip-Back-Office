...
Class Calculation extends Inf_Model {
    ...
    public function calculateLegCount($id, $father_id, $product_id, $child_position, $from_id = '') {
        ...
        if ($product_amount > 0) {
            ...
            $this->updateAllUpline($product_amount);
        }
        ...
        for ($i = 0; $i < $total_len; $i++) {
            ...
            $user_pair_arr = $this->getUserPair($user_id, $left_leg, $right_leg, $is_First_Pair, $ceiling_user, $product_point_value, $from_date, $to_date);
            ...
            if ($user_pair > 0) {
                ...
                $this->insertInToLegAmount($user_id, $left_leg, $right_leg, $user_pair, $total_amount, $amount_payable, $tds_amount, $service_charge, $date_of_sub, "leg", $from_id);
            ...
            /*             * * Reduce from ft_individual table bcoz it updated and added in leg_amount table ** */
        }
        return TRUE;
    }

    public function getUserPair($user_id, $left_leg, $right_leg, $is_First_Pair, $ceiling_user, $product_point_value, $from_date, $to_date) {
    ...
    function calculateLevelCommission($from_user, $father_id, $child_position, $product_id = '') {
        require_once 'Settings.php';

...
Class Validation extends Inf_Model {
    ...
    public function getPrdocutAmount($prodcut_id) {
        $prod_amnt = NULL;
        ...
        foreach ($res->result() as $row) {
            $prod_amnt = $row->product_value;
        }
        return $prod_amnt;
    }
    public function getReferralAmount($prodcut_id) {
        $referal_amount = NULL;
    ...
    public function getMailBody($lang_id = 1) {
